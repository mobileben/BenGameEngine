...
namespace BGE {
    ...
    extern void Matrix4MultiplyVector3(Vector3 &result, Matrix4& matrix, Vector3 v3);
    extern void Matrix4MultiplyVector2(Vector2 &result, Matrix4& matrix, Vector2 v2);
